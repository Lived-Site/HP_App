...
public class Mago : Personaje
{
    ...
    public Mago(string nombre, DateTime fechaNacimiento, string genero, string tipoRaza, string tipoSangre, int idCasa) : base(nombre, fechaNacimiento, genero, tipoRaza)
    {
